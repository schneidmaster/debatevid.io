...
const mapStateToProps = (state, ownProps) => {
  ...
  return {
    ...
    users,
    tagsUsers: users
      .sortBy(user => -user.tagsCount)
      .slice(tagsStart, tagsStart + itemsPerPage),
    videosUsers: users
      .sortBy(user => -user.videosCount)
      .slice(videosStart, videosStart + itemsPerPage),
    scoreUsers: users
      .sortBy(user => -user.score)
      .slice(scoreStart, scoreStart + itemsPerPage)
  };
};
