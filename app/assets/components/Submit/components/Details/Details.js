        ...
        <form onSubmit={handleSubmit}>
          ...
          {renderIf(affSchool)(
            <div>
              <FormGroup>
                <ControlLabel>
                  {debateType === 2 ? "Aff Debater" : "Aff Debater 1"}
                </ControlLabel>
                <Field
                  name="affDebaterOne"
                  options={affDebaters}
          ...
          {renderIf(negSchool)(
            <div>
              <FormGroup>
                <ControlLabel>
                  {debateType === 2 ? "Neg Debater" : "Neg Debater 1"}
                </ControlLabel>
                <Field
                  name="negDebaterOne"
                  options={negDebaters}
...
Details.propTypes = {
  ...
  affSchool: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  negSchool: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
