    ...
    <Navbar>
      ...
      <Navbar.Collapse>
        <Nav pullRight>
          ...
          {renderIf(loggedIn)(<NavItem href="/videos/new">Submit</NavItem>)}
          {renderIf(loggedIn)(() => (
            <NavDropdown
              id="nav-dropdown"
              title={dropdownTitle}
          ...
          {renderIf(!loggedIn)(
            ...
            >
              <MenuItem href="/auth/facebook">
                <img src={fb} alt="Facebook" className="nav-dropdown-img" />{" "}
                Facebook
              </MenuItem>
              <MenuItem href="/auth/twitter">
                <img src={twitter} alt="Twitter" className="nav-dropdown-img" />{" "}
                Twitter
              </MenuItem>
              <MenuItem href="/auth/google_oauth2">
                <img src={google} alt="Google" className="nav-dropdown-img" />{" "}
                Google
              </MenuItem>
            </NavDropdown>
          )}
