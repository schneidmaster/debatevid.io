class VideosController < ApplicationController
  ...
  def search
    ...
    videos = videos.joins(aff_team: [:debater_one, :debater_two]).joins(neg_team:  [:debater_one, :debater_two]).where('debaters.id = ? or debater_twos_teams.id = ?', search_param(:debater), search_param(:debater)) if search_param(:debater)
